...
export async function getProjects(
  ...
  try {
    ...
    let where =
      !isGuestUser && whereFilters && Object.values(whereFilters).filter(v => v !== undefined).length
        ? and(
    ...
    return {
      ...
      total: isGuestUser ? Math.min(projectsCount, DEFAULT_PAGE_SIZE) : projectsCount,
